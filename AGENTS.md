...
| `srv/projection.js` | Hidden-information redaction: public/private state slicing for games that opt in, plus the state/data wire-field split per event (see play-service.cds) |
